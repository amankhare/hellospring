...
public class Xls_Reader {
	...
	public Xls_Reader(String path, String Colours) 
	{
		String color="";
		String text="";
		String[] colorcombination = Colours.split(",");
		for(int i=0;i<colorcombination.length;i++)
		{
			color="";
			text="";
			try{
			text = colorcombination[i].substring(0,colorcombination[i].indexOf(":"));
			} catch (Exception e) 
			{
				System.out.println("---------------------------Please check the format");}
			text=text.toLowerCase();
			color = colorcombination[i].substring(colorcombination[i].indexOf(":")+1,colorcombination[i].length());
			color=color.toLowerCase();
			colorset.put(text, color);
	...
	public void setColor(String sheetName,String colName,int rowNum,String data )
	{
	String actualdata="";
	try{
		actualdata =data.substring(0, data.indexOf(" "));
	} catch (Exception e)
	{
		actualdata=data;
	...
	String color = colorset.get(actualdata);
	if(color!=null)
		{
			//this.setCellColour(sheetName, colName, rowNum, color,actualdata);
			this.setCellColour(sheetName, colName, rowNum, color, actualdata);
		}
	}

	public void setColor(String sheetName,int colNum,int rowNum,String data )
	{
	String actualdata="";
	try{
		actualdata =data.substring(0, data.indexOf(" "));
	} catch (Exception e){actualdata=data;}
		String color = colorset.get(actualdata);
		if(color!=null)
		{
			this.setCellColour(sheetName, colNum, rowNum, color,actualdata);
	...
	public boolean setCellData(String sheetName,int colNum,int rowNum, String data){
		...
		this.setColor(sheetName,colNum,rowNum,data);
	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data){
		...
		this.setColor(sheetName,colName,rowNum,data);
	...
	public boolean setCellColour(String sheetName, String colName, int rowNum, String color,String data)
	{
		try{
		fis = new FileInputStream(path);
		workbook = new HSSFWorkbook(fis);
	...
	public boolean setCellColour(String sheetName, int colNum, int rowNum, String color,String data)
	{try{
		fis = new FileInputStream(path);
		workbook = new HSSFWorkbook(fis);
	...
	public void ChooseColor(String color,CellStyle style)
	{		
	String Color=color;
		...
		if(Color.equalsIgnoreCase("BLACK"))
		{
			...
			if(Color.equalsIgnoreCase("BLUE"))
			{
				...
				if(Color.equalsIgnoreCase("BROWN"))
				{
					...
					if(Color.equalsIgnoreCase("CORAL"))
					{
						...
						if(Color.equalsIgnoreCase("GOLD"))
						{
							...
							if(Color.equalsIgnoreCase("GREEN"))
							{
								...
								if(Color.equalsIgnoreCase("INDIGO"))
								{
									...
									if(Color.equalsIgnoreCase("LAVENDER"))
									{
										style.setFillForegroundColor(IndexedColors.LAVENDER.getIndex());

									}
									else
										if(Color.equalsIgnoreCase("LEMON_CHIFFON"))
										{
											...
											if(Color.equalsIgnoreCase("LIME"))
											{
												...
												if(Color.equalsIgnoreCase("MAROON"))
												{
													...
													if(Color.equalsIgnoreCase("ORANGE"))
													{
														...
														if(Color.equalsIgnoreCase("ORCHID"))
														{
															...
															if(Color.equalsIgnoreCase("PINK"))
															{
																...
																if(Color.equalsIgnoreCase("PLUM"))
																{
																	...
																	if(Color.equalsIgnoreCase("RED"))
																	{
																		...
																		if(Color.equalsIgnoreCase("ROSE"))
																		{
	...
	public boolean setPinkColour(String sheetName,int colNum,int rowNum){
		try{
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
